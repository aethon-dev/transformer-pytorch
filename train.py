...
def train_model(config):
  ...
  for epoch in range(initial_epoch, config['num_epochs']):
    ...
    for batch in batch_iterator:
      ...
      encoder_output = model.encode(encoder_input, encoder_mask) # --> (batch x seq_len x d_model)
      decoder_output = model.decode(encoder_output, encoder_mask, decoder_input, decoder_mask) # --> (batch x seq_len x d_model)
      proj_output = model.project(decoder_output) # --> (batch x seq_len x tgt_vocab_size)
